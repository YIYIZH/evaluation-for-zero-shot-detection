...
def find_intersection(set_1, set_2):
    ...
    """
    n = set_1[:, :2].unsqueeze(1)
    j = set_2[:, :2].unsqueeze(0)
    y = set_1[:, 2:].unsqueeze(1)
    k = set_2[:, 2:].unsqueeze(0)
    # PyTorch auto-broadcasts singleton dimensions
    lower_bounds = torch.max(set_1[:, :2].unsqueeze(1), set_2[:, :2].unsqueeze(0))  # (n1, n2, 2)
    upper_bounds = torch.min(set_1[:, :2].unsqueeze(1) + set_1[:, 2:].unsqueeze(1), set_2[:, :2].unsqueeze(0) + set_2[:, 2:].unsqueeze(0))  # (n1, n2, 2)
